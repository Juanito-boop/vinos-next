      ...
      <div className="carousel-container">
        <div className="flex gap-1">
          <button
            ...
            children="←"
          />
          <div className="grid justify-center A:grid-cols-[repeat(1,_minmax(250px,_260px))] B:grid-cols-[repeat(2,_minmax(250px,_260px))] C:grid-cols-[repeat(3,_minmax(250px,_260px))] D:grid-cols-[repeat(4,_minmax(250px,_260px))] mx-auto">
